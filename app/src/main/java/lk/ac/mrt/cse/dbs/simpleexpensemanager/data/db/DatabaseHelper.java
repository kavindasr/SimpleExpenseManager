...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public  static final String DB_NAME = "180509T";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String q1 = "CREATE TABLE "+TABLE_1+" (accountNo TEXT(50) PRIMARY KEY,bankName TEXT(50),accountHolderName TEXT(50),balance REAL) ";
        String q2 =" CREATE TABLE "+TABLE_2+" (accountNo TEXT(50) ,date date, expenseType TEXT(20),amount REAL,FOREIGN KEY (accountNo) REFERENCES "+TABLE_1+"(accountNo))";
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int i, int i1) {
        String del1 = "DROP TABLE IF EXISTS "+TABLE_1;
        String del2 ="DROP TABLE IF EXISTS "+TABLE_2;
        sqLiteDatabase.execSQL(del1);
        sqLiteDatabase.execSQL(del2);
